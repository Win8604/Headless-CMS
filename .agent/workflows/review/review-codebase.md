...
- Use 2 `researcher.md` agent in parallel to search up to max 5 sources for the user's request, idea validation, best practices, challenges, and find the best possible solutions.
...
- Use `planner.md` agent to analyze reports from `researcher.md subagents to create an improvement plan following the progressive disclosure structure:
