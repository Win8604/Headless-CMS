...
- Use `search_web` tool to find efficient approaches and learn from others' experiences
- Use `docs-seeker` skill to read latest documentation of external plugins/packages
- Leverage `generate_image` skill to analyze visual materials and mockups
- Query `mysql` command to understand current database structure and existing data
- **ENTER PLANNING MODE** for complex problem-solving that requires structured analysis
